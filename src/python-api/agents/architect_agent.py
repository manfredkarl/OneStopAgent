        ...
        response = llm.invoke([
            {
                ...
                "content": (
                    ...
                    "}\n\n"
                    "LAYER GUIDELINES:\n"
                    "- 2-4 layers depending on the use case complexity\n"
                    "- TOTAL components across ALL layers: 5-8 (maximum 10)\n"
                    "- Each layer should have 1-3 components — be selective, not exhaustive\n"
                    "- Only include services that are ESSENTIAL for the MVP — skip nice-to-haves\n"
                    "- Do NOT add monitoring, logging, or CDN unless the user specifically asked for them\n"
